...
public class Jaccard {
	 ...
	 * @throws Exception
	 */
	public double[] calculateJaccard(LinkedHashMap<Integer, LinkedList<String>> m1,
			LinkedHashMap<Integer, LinkedList<String>> m2, boolean b) throws Exception {
	 ...
	 * @return
	 */
	private double jaccard(LinkedList<String> l1, LinkedList<String> l2) {
	 ...
	 * @return
	 */
	private double unionCardinality(LinkedList<String> l1, LinkedList<String> l2) {
	 ...
	 * @return
	 */
	private double intersectionCardinality(LinkedList<String> l1, LinkedList<String> l2) {
	 ...
	 * LinkedList<String>> map) throws InterruptedException {
	 * System.out.println("CLUSTERS"); for (Integer cluster : map.keySet()) {
